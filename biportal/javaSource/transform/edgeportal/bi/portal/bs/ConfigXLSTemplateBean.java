 ...
 *
 */
public class ConfigXLSTemplateBean {

	private String	request_id			= null;
	private String	sheet				= null;
	private String	new_sheet			= null;
	...
	public String getNew_sheet() {
		return new_sheet;
	}

	public void setNew_sheet(String new_sheet) {
		this.new_sheet = new_sheet;
	}
	...
	public static String beanToJson(ConfigXLSTemplateBean bean) {
		...
		json.append("\"new_sheet_name\":");
		json.append("\"").append(bean.getNew_sheet()).append("\",");
	...
	public static String listToJson(List<ConfigXLSTemplateBean> list) {
		StringBuilder json = new StringBuilder();
		json.append("{\"MSG\":");
		if (list.size() == 1) {
			ConfigXLSTemplateBean errorBean = list.get(0);
		...
		json.append("[");
		for (ConfigXLSTemplateBean bean : list) {
	...
	public boolean isEmptyObj() {
		String rowStr = this.request_id + this.sheet + this.new_sheet + this.range + this.hide_rows + this.hide_columns
				+ this.autofit_rows + this.autofit_columns + this.custom_column_width + this.custom_row_height
				+ this.wrap_text_rows + this.display_gridline;
