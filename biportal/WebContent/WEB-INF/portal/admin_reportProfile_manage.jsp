		...
		<div>
			<div>
				<div style="float: left;">
					<h1 class="ibm-h1 ibm-light">&nbsp;&nbsp;&nbsp;Report Profile - Existing Profiles&nbsp;</h1>
				</div>
				...
				<tbody>
					<tr>
						...
						<div id="mtmanager_buttondiv" class="ibm-btn-row ibm-left">
				            <a class="ibm-btn-pri ibm-btn-small ibm-btn-blue-50" href='<%=path%>/action/portal/addReportProfile' name="userprofile_btn" id="userprofile_btn_add"> Add </a>
